...
public class DepartementService
{
    ...
    public List<Departement> GetAllDepartements() => _departements;

    public Departement? GetDepartementByCode(string code) => 
        _departements.FirstOrDefault(d => d.Code == code);
    ...
    public List<Person> GetAllPersons() => 
        _departements.SelectMany(d => d.Persons).ToList();

    public Person? GetPersonById(int id) => 
        _departements.SelectMany(d => d.Persons).FirstOrDefault(p => p.Id == id);
